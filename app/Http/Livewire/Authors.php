...
class Authors extends Component
{
    ...
    public function AddAuthor()
    {
        ...
        $this->validate([
            ...
            'direct_publisher.required' => 'Specify author publisher access'
        ]);

        // Checking online before add author
        if ($this->isOnline()) {
            ...
            $this->showToastr('You are offline, check your connection and submit form again later', 'errord');
        }
