            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $post->post_title }}" name="post_title" placeholder="Enter post title">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="ckeditor form-control" id="post_content" name="post_content" rows="6" placeholder="Content..">
                            {!! $post->post_content !!}
                        </textarea>
