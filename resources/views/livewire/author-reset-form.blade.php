    ...
    <form class="card card-md" wire:submit.prevent='ResetHandler()' method="POST" autocomplete="off">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" wire:model='email' class="form-control" placeholder="Enter email address" disabled>
            ...
            <div class="mb-2">
                ...
                <div class="input-group input-group-flat">
                    <input type="password" wire:model='confirm_new_password' class="form-control" placeholder="Confirm Password" autocomplete="off">
                    <span class="input-group-text">
                        <a href="#" class="link-secondary" title="" data-bs-toggle="tooltip"
                            data-bs-original-title="Show password">
                            <!-- Download SVG icon from http://tabler-icons.io/i/eye -->
